...
public class Fr_DangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 430, 380));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/preview_1.png"))); // NOI18N
        jLabel10.setText("jLabel10");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 140, 190));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        int check = JOptionPane.showConfirmDialog(this, "Bạn muốn thoát chứ ?");
        if(check  == 0 ){
            System.exit(0);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        for (double i = 0.0; i <=1.0; i = i+0.3){
            String val = i+ "";
